...
Full RTL-to-GDSII implementation via OpenLane 2 ,synthesized with Yosys, with DRC/LVS/antenna signoff in Magic and KLayout.
...
Full metrics: top_cpu8/Final GDS Output/metrics.csv
